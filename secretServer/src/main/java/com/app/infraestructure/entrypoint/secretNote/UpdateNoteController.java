...
public class UpdateNoteController {
    ...
    @Autowired
    private SecretUpdateNoteUseCase updateUseCase;

    @PostMapping(Constant.PATH_SECRET_NOTE_UPDATE)
    public Mono<ResponseEntity<ApiResponse>> secretUpdateNote(@RequestBody secretUpdateNoteRequestDTO requestDTO){
        return Mono.fromCallable(() -> requestDTO)
                .flatMap(updateUseCase::updateNote)
